          ...
          <div className="container">
            ...
            <div className="row border-bottom border-3 border-dark mt-5">
              <div className="col-lg-12">
                ...
                <h6 className="text-muted text-secondary">Hosted by {host}</h6>
              </div>
            </div>
            ...
            <div className="row mt-4 justify-content-around">
              <div className="col-lg-5 text-center">
                <Image
                  src={eventImage ? eventImage : "/BigThumbnail.svg"}
                  alt="Event Image"
                  width={450}
                  height={300}
                />
            ...
            <div className="row">
              ...
              <div className="col-lg-12">
                <div className="py-3">
                  <h6 className="lh-base">{eventDescription}</h6>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              {participants.map((member, index) => {
                return (
                  <div key={index} className="col-lg-2 col-auto mx-auto">
                    <UserAttend username={member.user_id} wide={200} />
                  </div>
                );
              })}
            </div>
              ...
              return (
                ...
                >
                  <div className="col-lg-1 col-3">
                    <UserAttend username={item.user_id} wide={100} />
                  </div>
                  <div
                    className="col-lg-10 col-9 border border-2 bg-white py-3 px-4 mb-lg-5 my-auto"
                    style={{ borderRadius: 1 + "em" }}
                  >
                    <p style={{ color: "#212840" }}>{item.comment}</p>
                  </div>
                </div>
              );
            })}
